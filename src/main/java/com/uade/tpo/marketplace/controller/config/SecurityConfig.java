...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                  http
                                    ...
                                    .authorizeHttpRequests(req -> req.requestMatchers("/api/v1/auth/**").permitAll()
                                                      ...
                                                      // Permitir temporalmente el endpoint de creación con imagen para pruebas (no recomendado en producción)
                                                      .requestMatchers("/games/admin/create-with-image").permitAll()
        ...
        CorsConfigurationSource corsConfigurationSource() {
                ...
                // Define las mismas reglas que usarías en la configuración global
